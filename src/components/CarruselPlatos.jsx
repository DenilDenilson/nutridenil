...
export default function CarruselPlatos() {
  ...
  useEffect(() => {
    function fetchData() {
      fetch("https://pokeapi.co/api/v2/pokemon/ditto")
        .then((res) => res.json())
        .then((data) => setRecipes(data.abilities));
    }
    fetchData();
  }, []);
...
// const apiKey = "7d5f2d4e10c14a04ae9dbd0a957f70ce";
// const urlBase = "https://api.spoonacular.com";
// const apiAuthentication = `?apiKey=${apiKey}`;

// // https://api.spoonacular.com/food/products/search?query=pizza&number=2&apiKey=7d5f2d4e10c14a04ae9dbd0a957f70ce
// // https://api.spoonacular.com/recipes/1003464/nutritionWidget
...
//     function fetchData() {
//       return fetch(
//         `${urlBase}/recipes/192386/nutritionWidget.json${apiAuthentication}`
...
//               {data.good.map((item) => (
//                 <li>
//                   {item.title} : {item.amount} / {item.percentOfDailyNeeds}
//                 </li>
//               ))}
//             </ul>
