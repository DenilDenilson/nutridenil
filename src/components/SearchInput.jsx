...
const InputWithIcon = ({ ActiveSearch, style }) => {
  return (
    <div
      id="searchInput"
      className="relative before:content-[' '] before:absolute before:-left-4 before:-right-4 before:-top-16 before:min-w-full before:min-h-screen before:z-[90] before:backdrop-blur-sm before:bg-gray-BG_alt/20 before:opacity-80 before:filter before:blur-sm"
    >
